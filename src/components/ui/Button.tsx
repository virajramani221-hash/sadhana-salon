  ...
  ({ className, variant = "primary", children, onClick, ...props }, ref) => {
    ...
    return (
      <motion.button
        ...
        onClick={handleClick}
        className={cn(
          "relative overflow-hidden inline-flex items-center justify-center transition-colors duration-300 min-h-[44px] min-w-[44px] px-8 py-4 font-body tracking-widest-2 uppercase text-sm cursor-pointer",
          {
